...
public class Messager {
    ...
    public void sendTitle(float fadein, float fadeout, float stay, Player receiver, String title, String subtitle, SoundType sound)
    {
        ...
        PacketPlayOutTitle packetPlayOutTitle = new PacketPlayOutTitle(EnumTitleAction.TITLE, ChatSerializer.a("{\"text\": \"쬻" + title + "\"}"));
        PacketPlayOutTitle packetPlayOutSubtitle = new PacketPlayOutTitle(EnumTitleAction.SUBTITLE, ChatSerializer.a("{\"text\": \"쬻" + subtitle + "\"}"));
    ...
    public void sendActionBar(final Player receiver, final SoundType sound, String text)
    {
    	...
    	//L채het채 actionbar
    	CraftPlayer player = (CraftPlayer) receiver;
        IChatBaseComponent chatBaseComponent = ChatSerializer.a("{\"text\": \"쬻" + text + "\"}");
