...
public class PlayerNameComponent extends ChatComponent {

	public PlayerNameComponent(String key) {
		super(key);
	}
	...
	public HashMap<Player, TextComponent> getChatText(Player sender, Set<Player> receivers) {
		...
		for(Player player : receivers)
			map.put(player, new TextComponent(TextComponent.fromLegacyText(sender.getName())));
		return map;
	}
}
