...
public class ComponentName implements HoverComponent, ClickComponent {
	@Override
	public HashMap<Player, BaseComponent> getHover(Player sender, Set<Player> receivers) {
		...
		for(Player player : receivers)
			com.put(player, new TextComponent(TextComponent.fromLegacyText(sender.getName())));
