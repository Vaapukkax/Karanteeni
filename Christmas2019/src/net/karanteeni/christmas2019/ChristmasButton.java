...
public class ChristmasButton extends ActionBlock implements ActionBlock.Events.PlayerInteractEvent {
	private Long earliestPress = null;
	private Integer day = null;
	
	public ChristmasButton(Block block) throws IllegalArgumentException {
		super(block);
	}
	
	
	public ChristmasButton(Block block, UUID uuid) throws IllegalArgumentException {
		super(block, uuid);
	}
