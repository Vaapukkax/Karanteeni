...
public class CreateToRequirement extends MissionRequirement {

	public CreateToRequirement(@NonNull String requirementId, @NonNull RequirementType type, @NonNull Mission mission) {
