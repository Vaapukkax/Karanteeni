...
public class DeliverRequirement extends MissionRequirement {

	public DeliverRequirement(@NonNull String requirementId, @NonNull RequirementType type, @NonNull Mission mission) {
